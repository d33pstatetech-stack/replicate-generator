...
//
// Counts: 16 models (CATALOG entries).
const AZNTEN_SCHEMA = {
...
// Standalone trained model — same wrapper as AZNTEN_SCHEMA plus the second
// stacking slot (replicate_weights) from the live be6b57b0 schema (2026-09-11).
const AZNTEN_DEV_REPLICATE_SCHEMA = (()=>{
  const s = JSON.parse(JSON.stringify(AZNTEN_SCHEMA));
  s.properties.replicate_weights = {"type":"string","title":"Replicate Weights","x-order":21,"description":"Load LoRA weights from a Replicate model (owner/name or owner/name/version). Second stacking slot alongside extra_lora."};
  return s;
})();
...
const CATALOG = [
  ...
  { id:"d33pstatetech-stack/aznten-flux.1-dev-replicate", name:"AZNTEN FLUX.1-dev (standalone)", group:"image", category:"Image · Flux LoRA", version:"d33pstatetech-stack/aznten-flux.1-dev-replicate:be6b57b05d69042bac4db99c9eebb22afcaf9e7aa3839cdd30e5cebd8c34d604", description:"Trained FLUX.1-dev LoRA as standalone model (2026-09-07) — baked weights, trigger word, lora_scale -1..3, extra_lora + replicate_weights stacking slots. Unrestricted by default.", schema: AZNTEN_DEV_REPLICATE_SCHEMA },
  ...
  { id:"qwen/qwen-image", name:"Qwen-Image (LoRA-capable)", group:"image", category:"Image · Qwen", version:"qwen/qwen-image:0bba9e70f78437359725e0989ead45ca8b09e6c12a070dfe9a09e6856b43a44d", description:"Qwen-Image with lora_weights / extra_lora_weights slots — Replicate-side target for Qwen LoRAs (e.g. aznten-Qwen-Image-2512). T2I pipeline only for LoRA.", schema: QWEN_IMAGE_SCHEMA },
