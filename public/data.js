...
const USER_LORAS = [
  {
    ...
    suggested_target: "d33pstatetech-stack/aznten_replicate (model=dev, extra_lora) or black-forest-labs/flux-dev",
    replicate_model: "d33pstatetech-stack/aznten_replicate",
    note: "FLUX.1-dev LoRA, trigger 'aznten'. Use as extra_lora on AZNTEN Flux LoRA model: paste huggingface.co/D33pStateTech/aznten-flux.1-dev-replicate"
  },
  {
    ...
    suggested_target: "d33pstatetech-stack/aznten_replicate (model=schnell, extra_lora)",
    replicate_model: "d33pstatetech-stack/aznten_replicate",
  ...
  },
  {
    ...
    note: "Krea-2-Raw LoRA, trigger 'aznten'. Public repo. For Replicate Krea, use style_reference_images; for local diffusers use Krea2Pipeline with this LoRA."
  },
  {
